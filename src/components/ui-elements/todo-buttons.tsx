...
async function addTask({ name, color, uid }: { name: string; color: ColorList; uid: string }) {
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>追加するタスクの情報を入力して下さい</DialogDescription>
          </DialogHeader>
          <form onSubmit={form.handleSubmit(onSubmit)} id="task-addition">
            <FieldGroup>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="task-addition-name">タスク名</FieldLabel>
                    <Input {...field} id="task-addition-name" aria-invalid={fieldState.invalid} placeholder="タスク名を入力して下さい" />
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field>
                    <FieldLabel htmlFor="task-addition-color">タスクの色</FieldLabel>
